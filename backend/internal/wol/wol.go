...
func selectWolNetwork(h *config.Host, network wolNetwork) (*net.UDPAddr, *net.UDPAddr, error) {
...
func SendWol(h *config.Host) error {
...
func sendWol(h *config.Host, network wolNetwork) error {
